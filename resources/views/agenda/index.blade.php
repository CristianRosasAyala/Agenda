@extends('plantilla.plantilla') {{-- Extendemos de plantilla --}}

@section('titulo', 'Agenda') {{-- Cambiamos el titulo de la plantilla --}}

{{-- Cambiando el contenido de la plantilla  --}}
@section('contenido')
...
{{-- Validando el registro con ventana emergente --}}
...
<table class="table-responsive table text-center">
                                ...
                                {{ $Agenda->appends(Request::only(['tipo'. 'buscarpor']))->links()}} {{-- Para hacer la paginación, tambien necesita editar en el controlador --}}
</div>
